...
#ifndef RTW_HEADER_regulering_model_acc_private_h_
#define RTW_HEADER_regulering_model_acc_private_h_
#include "rtwtypes.h"
...
; real_T regulering_model_acc_rt_TDelayInterpolate ( real_T tMinusDelay ,
